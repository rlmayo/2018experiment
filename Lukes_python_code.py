...
def consent():
    ...
    if not subject:
        ...
        conn.commit()
        c.close()
    return template('/tpl/consent') #consent tpl file

#Page: Attention Test
@route('/attention')
def attention():
    return template('/tpl/attention') #attention tpl file
...
def treatment():
    ...
    return template('/tpl/question', treatment = treatment) #question tpl file, treatment variable
...
def survey():
    ...
    if request.GET.save:
        ...
        return template('/tpl/survey') #survey tpl file,
...
def earnings():
    ...
    return template('/tpl/earnings', earnings = earnings, code = code) #earnings template, earnings and code variables
